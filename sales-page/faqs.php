...
$faqs = [
    [
        ...
        "answer" => "<span class=text-[#FC9850]>Spookids</span> is a collection of short horror videos for kids. Created and can be edited using Canva."
    ],
    [
    ...
    [@
        ...
        "answer" => "Spookids is perfect for: <br><br>
            ...
            Digital Marketer Who wants to sell digital products."
    ],
    [
    ...
    [
        ...
        "answer" => "If you have any further questions about Spookids, please don't hesitate to contact us at <a class=text-[#FC9850] href=mailto:creator@videokedavra.com>creator@videokedavra.com</a>. We're always happy to help!"
    ],
    [
        "question" => "Q : Do You Offer Money Back Guarantee ?",
        "answer" => "You should pay attention to our requirements,<span class=text-[#FC9850]> we DO the refund if there is an issue with the product and our technical support can’t solve it for you.</span> And we’ll provide a refund for you within 30 days of your purchase. <br><br>
