...
<body>
    <div class="container-lg bg-1">
        <div class="flex flex-col items-center justify-center h-screen px-5">
            <div class="border-0 bg-[#FFFFFF] rounded-2xl px-4 md:px-6 lg:px-8 py-5 w-full md:w-[40%] h-[60%] md:h-[90%] flex flex-col items-center justify-center text-center text-[#121212]">
                <div class="flex flex-row items-center justify-center">
                    <h3 class="satoshi font-bold font-2rem text-[#1678F2]">
    ...
    <div id="intro" class="container-lg bg-3">
        <div class="flex flex-col items-center justify-center text-center p-5 py-16 text-[#312E35]">
            <h1 class="satoshi font-bold font-3rem leading-tight w-full md:w-[80%]">
            ...
            <h3 class="satoshi font-2-5rem my-16 w-full md:w-[80%]">
    ...
    <div class="container-lg bg-1">
        <div class="flex flex-col items-center justify-center p-3 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-8 mx-0 md:mx-8 lg:mx-24 p-3 text-white">
                <div class="border-0 bg-[#FFFFFF] drop-shadow-lg rounded-2xl h-full md:h-[55%]">
                    <h1 class="bg-1 satoshi font-bold font-2rem mt-8 py-3 text-[#FFFFFF] text-center">
